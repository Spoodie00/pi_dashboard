<h1>TODO:</h1>
* Some kind of "temperature rise last hour for mainpage
* Oppfølging på siste, grader/min eller per time
...
* Grad-timer hadde vært kult "timer under x grader denne perioden"
* Estimer energien i rommet ut i fra volum luft, trykk etc
